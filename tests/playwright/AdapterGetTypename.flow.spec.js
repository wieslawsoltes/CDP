...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: Window.DataContext.Elements.SelectedNode.TypeName != null', async () => {
      const result = await page.evaluate('Window.DataContext.Elements.SelectedNode.TypeName != null');
      await expect(result).toBeTruthy();
    });
