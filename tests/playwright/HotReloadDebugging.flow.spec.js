...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: Window.DataContext.Elements.SelectedNode.Attributes.Any(a => a.Name == \'Height\' && a.Value == \'600\')', async () => {
      const result = await page.evaluate('Window.DataContext.Elements.SelectedNode.Attributes.Any(a => a.Name == \'Height\' && a.Value == \'600\')');
      await expect(result).toBeTruthy();
    });
