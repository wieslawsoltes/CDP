...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: Window.DataContext.Elements.SelectedNode.TypeName.Contains(\'Avalonia\')', async () => {
      const result = await page.evaluate('Window.DataContext.Elements.SelectedNode.TypeName.Contains(\'Avalonia\')');
      await expect(result).toBeTruthy();
    });
