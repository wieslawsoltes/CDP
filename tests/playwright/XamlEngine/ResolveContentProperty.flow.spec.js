...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: Window.DataContext.Elements.SelectedNode.Properties.Any(p => p.Name == \'Content\')', async () => {
      const result = await page.evaluate('Window.DataContext.Elements.SelectedNode.Properties.Any(p => p.Name == \'Content\')');
      await expect(result).toBeTruthy();
    });
