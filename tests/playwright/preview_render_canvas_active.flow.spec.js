...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: document.querySelector(\'#imgScreenshot\').isVisible == true', async () => {
      const result = await page.evaluate('document.querySelector(\'#imgScreenshot\').isVisible == true');
      await expect(result).toBeTruthy();
    });
