...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: document.querySelector(\'#imgScreenshot\').bounds != null', async () => {
      const result = await page.evaluate('document.querySelector(\'#imgScreenshot\').bounds != null');
      await expect(result).toBeTruthy();
    });
