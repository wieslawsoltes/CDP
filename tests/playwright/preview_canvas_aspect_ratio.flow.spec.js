...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: __raw_window.DataContext.Preview.KeepAspectRatio == true', async () => {
      const result = await page.evaluate('__raw_window.DataContext.Preview.KeepAspectRatio == true');
      await expect(result).toBeTruthy();
    });
