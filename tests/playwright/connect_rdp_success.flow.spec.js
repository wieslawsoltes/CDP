...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: __raw_window.DataContext.Connection.StatusText == \'Connected\'', async () => {
      const result = await page.evaluate('__raw_window.DataContext.Connection.StatusText == \'Connected\'');
      await expect(result).toBeTruthy();
    });
