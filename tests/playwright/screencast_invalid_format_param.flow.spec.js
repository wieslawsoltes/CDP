...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Evaluate Script: __raw_window.DataContext.Recorder.FrameFormat = \'bmp\'', async () => {
      await page.evaluate('__raw_window.DataContext.Recorder.FrameFormat = \'bmp\'');
    });
    ...
    await test.step('Assert True: __raw_window.DataContext.Recorder.FrameFormat == \'png\' || __raw_window.DataContext.Recorder.FrameFormat == \'jpeg\'', async () => {
      const result = await page.evaluate('__raw_window.DataContext.Recorder.FrameFormat == \'png\' || __raw_window.DataContext.Recorder.FrameFormat == \'jpeg\'');
      await expect(result).toBeTruthy();
    });
