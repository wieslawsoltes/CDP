...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: __raw_window.DataContext.Preview.DirtyRegionCount >= 0', async () => {
      const result = await page.evaluate('__raw_window.DataContext.Preview.DirtyRegionCount >= 0');
      await expect(result).toBeTruthy();
    });
