...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Evaluate Script: __raw_window.DataContext.Preview.ResetBuffer()', async () => {
      await page.evaluate('__raw_window.DataContext.Preview.ResetBuffer()');
    });

    // Warning: Unsupported step type 'takeScreenshot'
