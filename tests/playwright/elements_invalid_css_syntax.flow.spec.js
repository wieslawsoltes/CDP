...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert False: document.querySelector(\'!!!invalid_selector<<<\') != null', async () => {
      const result = await page.evaluate('document.querySelector(\'!!!invalid_selector<<<\') != null');
