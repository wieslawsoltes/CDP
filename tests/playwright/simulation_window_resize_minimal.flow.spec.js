...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Evaluate Script: __raw_window.Width = 320; __raw_window.Height = 240;', async () => {
      await page.evaluate('__raw_window.Width = 320; __raw_window.Height = 240;');
    });
