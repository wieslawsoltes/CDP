...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Tap on element #btnDeleteAttr', async () => {
      const element_6 = page.locator('#btnDeleteAttr');
      await element_6.tap();
    });
    ...
    await test.step('Assert True: !Window.DataContext.Elements.SelectedNode.Attributes.Any(a => a.Name == \'Tag\')', async () => {
      const result = await page.evaluate('!Window.DataContext.Elements.SelectedNode.Attributes.Any(a => a.Name == \'Tag\')');
      await expect(result).toBeTruthy();
    });
