...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Evaluate Script: document.querySelector(\'#hiddenControl\').bounds.width == 0', async () => {
      await page.evaluate('document.querySelector(\'#hiddenControl\').bounds.width == 0');
    });
