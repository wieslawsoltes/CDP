...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Tap on element #chkShowOverlay', async () => {
      const element_10 = page.locator('#chkShowOverlay');
    ...
    await test.step('Assert True: document.querySelector(\'#overlayCanvas\') != null', async () => {
      const result = await page.evaluate('document.querySelector(\'#overlayCanvas\') != null');
      await expect(result).toBeTruthy();
    });
