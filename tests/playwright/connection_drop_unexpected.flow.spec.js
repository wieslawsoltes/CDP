...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Evaluate Script: __raw_window.DataContext.Connection.SimulateNetworkDrop()', async () => {
      await page.evaluate('__raw_window.DataContext.Connection.SimulateNetworkDrop()');
    });
    ...
    await test.step('Assert element #lblConnectionError is visible', async () => {
      await expect(page.locator('#lblConnectionError')).toBeVisible();
    });
