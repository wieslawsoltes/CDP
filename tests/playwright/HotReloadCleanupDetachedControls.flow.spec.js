...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: Window.DataContext.Elements.RootNodes != null', async () => {
      const result = await page.evaluate('Window.DataContext.Elements.RootNodes != null');
      await expect(result).toBeTruthy();
    });
