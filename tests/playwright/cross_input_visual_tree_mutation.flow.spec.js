...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Tap on element #btnToggleExtraPanel', async () => {
      const element_6 = page.locator('#btnToggleExtraPanel');
      await element_6.tap();
    });
    ...
    await test.step('Assert True: document.querySelector(\'#extraPanel\') != null', async () => {
      const result = await page.evaluate('document.querySelector(\'#extraPanel\') != null');
      await expect(result).toBeTruthy();
    });
