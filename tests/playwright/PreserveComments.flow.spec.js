...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: Window.DataContext.Sources.ActiveEditor.Text.Contains(\'<!--\')', async () => {
      const result = await page.evaluate('Window.DataContext.Sources.ActiveEditor.Text.Contains(\'<!--\')');
      await expect(result).toBeTruthy();
    });
