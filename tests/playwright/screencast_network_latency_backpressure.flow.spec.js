...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Evaluate Script: __raw_window.DataContext.Recorder.SimulateNetworkLatency(300)', async () => {
      await page.evaluate('__raw_window.DataContext.Recorder.SimulateNetworkLatency(300)');
    });
