...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Tap on element #btnSaveTrace', async () => {
      const element_3 = page.locator('#btnSaveTrace');
      await element_3.tap();
    });
    ...
    await test.step('Tap on element #btnLoadTrace', async () => {
      const element_5 = page.locator('#btnLoadTrace');
      await element_5.tap();
    });
