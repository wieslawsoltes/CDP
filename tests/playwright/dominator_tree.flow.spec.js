...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Tap on element #TabDominatorTree', async () => {
      const element_12 = page.locator('#TabDominatorTree');
    ...
    await test.step('Assert True: __raw_window.DataContext.Memory.HierarchicalDominators != null', async () => {
      const result = await page.evaluate('__raw_window.DataContext.Memory.HierarchicalDominators != null');
      await expect(result).toBeTruthy();
    });
