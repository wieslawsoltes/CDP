...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: Window.DataContext.Elements.SelectedNode.Attributes.Any(a => a.Name == \'Tag\' && a.Value == \'test\')', async () => {
      const result = await page.evaluate('Window.DataContext.Elements.SelectedNode.Attributes.Any(a => a.Name == \'Tag\' && a.Value == \'test\')');
      await expect(result).toBeTruthy();
    });
