...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Evaluate Script: __raw_window.DataContext.Elements.ExpandAllNodes()', async () => {
      await page.evaluate('__raw_window.DataContext.Elements.ExpandAllNodes()');
    });
    ...
    await test.step('Assert True: __raw_window.DataContext.Elements.TreeDepth > 10', async () => {
      const result = await page.evaluate('__raw_window.DataContext.Elements.TreeDepth > 10');
      await expect(result).toBeTruthy();
    });
