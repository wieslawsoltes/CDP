...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Evaluate Script: __raw_window.Width = 3840; __raw_window.Height = 2160;', async () => {
      await page.evaluate('__raw_window.Width = 3840; __raw_window.Height = 2160;');
    });
    ...
    await test.step('Assert True: __raw_window.DataContext.Preview.RenderWidth == 3840', async () => {
      const result = await page.evaluate('__raw_window.DataContext.Preview.RenderWidth == 3840');
      await expect(result).toBeTruthy();
    });
