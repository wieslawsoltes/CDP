...
test.describe('CDP Recorded Tests', () => {
  test('recorded test', async () => {
    ...
    await test.step('Assert True: Window.DataContext.Elements.SelectedNode.Attributes.Any(a => a.Name == \'IsEnabled\' && a.Value == \'False\')', async () => {
      const result = await page.evaluate('Window.DataContext.Elements.SelectedNode.Attributes.Any(a => a.Name == \'IsEnabled\' && a.Value == \'False\')');
      await expect(result).toBeTruthy();
    });
