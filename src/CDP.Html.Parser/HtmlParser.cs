...
public static class HtmlParser
{
    ...
    private static readonly string[] CommonStrings = new[]
    {
        ...
        "br", "hr", "table", "tr", "td", "th", "thead", "tbody", "section", "nav", "header",
        "footer", "aside", "main", "canvas", "svg", "class", "id", "style", "href", "src",
        "type", "value", "name", "placeholder", "alt", "width", "height", "rel", "target",
        "onclick", "onload", "charset", "content", "media", "disabled", "readonly", "checked",
        "selected", "multiple", "required", "action", "method", "rows", "cols", "colspan", "rowspan"
    };
